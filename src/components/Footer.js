            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start">
              ...
              <div className="md:col-span-5">
                ...
                <div className="mt-6 flex items-center gap-3">
                  <a href="https://facebook.com/JohnEasterRealEstate" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="inline-flex items-center justify-center w-11 h-11 rounded-md bg-white/5 border border-white/6 shadow hover:bg-white/6 hover:scale-105 transition">
                  ...
                  {/* Twitter/LinkedIn removed — links pointed to "#"; re-add when real profiles exist */}
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <ul className="mt-4 space-y-3 text-sm">
                  ...
                  <li>
                    <Link href="/lakefront" className="inline-flex items-center px-3 py-2 rounded-full bg-white/5 text-slate-100 hover:bg-white/10 transition">
                      Lakefront Homes
                    </Link>
                  </li>
                  <li>
