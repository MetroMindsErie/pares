...
const Stablecoin = () => {
  return (
    <section className="relative overflow-hidden rounded-lg" style={{
      ...
      paddingTop: '50%', // Responsive aspect ratio
    }}>
        ...
        <div className="bg-white bg-opacity-95 p-8 rounded-lg shadow-xl max-w-5xl mx-auto text-center md:text-left">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8">
              <button className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-8 py-4 rounded-full font-semibold hover:from-blue-700 hover:to-blue-900 transition duration-300 shadow-md">
                Start Exploring Now!
              </button>
            </div>
          </div>
