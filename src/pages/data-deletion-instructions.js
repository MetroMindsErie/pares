        ...
        <div className="max-w-4xl mx-auto pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-blue-700 mb-3">Option 1: Delete through your account settings</h2>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-blue-700 mb-3">Option 2: Contact us directly</h2>
                ...
                <p className="my-2">
                  <a href="mailto:privacy@pares.com" className="text-blue-600 hover:text-blue-800 font-medium">
                    privacy@pares.com
                  </a>
                </p>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-blue-700 mb-3">What happens when you delete your account</h2>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-blue-700 mb-3">Data from Facebook</h2>
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:privacy@pares.com" className="text-blue-600 hover:text-blue-800 mx-1">privacy@pares.com</a>.
              </p>
