      ...
      <main className="pt-16 min-h-screen bg-gradient-to-br from-white to-gray-50" style={backgroundPattern}>
        ...
        <motion.div 
          ...
          style={{
            ...
            minHeight: '550px' // Increased height to accommodate search bar
          }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 to-indigo-900/80"></div>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center relative z-10 py-12">
            <motion.div 
            ...
            >
              <button
                className="px-6 py-3 bg-white bg-opacity-20 hover:bg-opacity-30 backdrop-blur-sm text-white rounded-lg font-medium transition-all flex items-center gap-2 border border-white border-opacity-30"
